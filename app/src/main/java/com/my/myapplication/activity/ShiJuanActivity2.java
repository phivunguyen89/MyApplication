...
public class ShiJuanActivity2 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shijuan2);
...
//                Toast.makeText(ShiJuanActivity1.this,"您的得分是："+score+"分！",Toast.LENGTH_SHORT).show();
                ...
                intent.setClass(ShiJuanActivity2.this,ResultActivity.class);
